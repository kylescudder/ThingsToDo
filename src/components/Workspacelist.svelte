...
<header
	class="bg-blue-500 dark:bg-gray-700 text-gray-100 flex justify-between md:hidden"
	data-dev-hint="mobile menu bar"
>
	<p class="block p-4 text-white font-bold whitespace-nowrap truncate">ThingsToDo</p>
